...
def engine_version():
    ...
    return hashlib.sha256(b''.join((root / name).read_bytes().replace(b'\r\n', b'\n') for name in
        ('connectors.py', 'microsoft.py', 'arte.py', 'patreon.py', 'toongoggles.py', 'tubetugraz.py', 'worker.py', 'catalog.py', 'pagination.py', 'verification.py', 'registry.py', 'vault.py', 'failures.py', 'adapters.py', 'access.py', 'discovery.py', 'relay.py', 'playback.py', 'main.py', 'library.py', 'egress.py', 'static/playback.js', 'static/vendor/shaka-player.js'))).hexdigest()[:16]
